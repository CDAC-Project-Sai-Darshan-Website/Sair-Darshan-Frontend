...
function UpcomingDarshan({ bookings, users }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Upcoming Darshan Bookings</h1>
        <p className="text-gray-600">Total {bookings.length} darshan bookings</p>
      </div>

      {bookings.length === 0 ? (
        <div className="bg-white rounded-xl shadow-md p-12 text-center">
          <div className="text-4xl mb-4">🧍♂️</div>
          <p className="text-gray-600">No upcoming darshan bookings</p>
        </div>
      ) : (
...
export default UpcomingDarshan;