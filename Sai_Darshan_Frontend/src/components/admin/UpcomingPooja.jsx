import { Calendar, Clock, IndianRupee, Mail, Phone } from 'lucide-react';

function UpcomingPooja({ bookings, users }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Upcoming Pooja Bookings</h1>
        <p className="text-gray-600">Total {bookings.length} pooja bookings</p>
      </div>

      {bookings.length === 0 ? (
        <div className="bg-white rounded-xl shadow-md p-12 text-center">
          <div className="text-4xl mb-4">🪔</div>
          <p className="text-gray-600">No upcoming pooja bookings</p>
        </div>
      ) : (
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center text-gray-700">
                      ...
                      <div>
                        ...
                        <p className="font-medium">Morning (10:00 AM)</p>
                      </div>
                    </div>
                  </div>
